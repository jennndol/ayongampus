...
from ayongampus.quiz.truefalse import TF_Question
...
from quiz.quiz_types.multichoice.models import Answer
from quiz.quiz_types.multichoice.models import MCQuestion

from .models import Subject, Quiz, Progress, Sitting, Chapter
from .views import (anon_session_score, QuizListView,
                    QuizDetailView)
...
class TestQuiz(TestCase):
    def setUp(self):
        ...
        self.c1 = Subject.objects.new_subject(subject='elderberries', author=self.u)

        self.quiz1 = Quiz.objects.create(id=1,
                                         title='test quiz 1',
                                         description='d1',
                                         url='tq1', author=self.u)
        self.quiz2 = Quiz.objects.create(id=2,
                                         title='test quiz 2',
                                         description='d2',
                                         url='t q2', author=self.u)
        self.quiz3 = Quiz.objects.create(id=3,
                                         title='test quiz 3',
                                         description='d3',
                                         url='t   q3', author=self.u)
        self.quiz4 = Quiz.objects.create(id=4,
                                         title='test quiz 4',
                                         description='d4',
                                         url='T-!£$%^&*Q4', author=self.u)
    ...
    def test_quiz_options(self):
        ...
        self.assertEqual(q5.subject.subject, self.c1.subject)
...
class TestProgress(TestCase):
    ...
    def test_list_all_empty(self):
        ...
        subject_dict = self.p1.list_all_cat_scores

        self.assertIn(str(list(subject_dict.keys())[0]), self.p1.score)

        self.assertIn(self.c1.subject, self.p1.score)

        Subject.objects.new_subject(subject='cheese')

        self.p1.list_all_cat_scores

        self.assertIn('cheese', self.p1.score)

    def test_chapter_all_empty(self):
        Chapter.objects.create(chapter='pickles',
    ...
    def test_update_score(self):
        ...
        cheese = Subject.objects.new_subject(subject='cheese')
...
class TestSitting(TestCase):
    def setUp(self):
        self.author = User.objects.create_superuser(username='FiRmAn')
        self.quiz1 = Quiz.objects.create(id=1,
                                         title='test quiz 1',
                                         description='d1',
                                         url='tq1',
...
class TestNonQuestionViews(TestCase):
    ...
    def setUp(self):
        self.c1 = Subject.objects.new_subject(subject='elderberries', author=self.u)
        self.c2 = Subject.objects.new_subject(subject='straw.berries', author=self.u)
        self.c3 = Subject.objects.new_subject(subject='black berries', author=self.u)
        ...
        self.quiz1 = Quiz.objects.create(id=1,
                                         ...
                                         url='tq1',
                                         subject=self.c1,
                                         single_attempt=True, author=self.u)
        self.quiz2 = Quiz.objects.create(id=2,
                                         title='test quiz 2',
                                         description='d2',
                                         url='t q2', author=self.u)
    ...
    def test_index(self):
        ...
        self.assertContains(response, 'Django Quiz')
    ...
    def test_view_cat(self):
        ...
        # integration test
        response = self.client.get('/subject/elderberries/')
    ...
    def test_quiz_start_page(self):
        ...
        self.assertEqual(view.get_object().subject, self.c1)
...
class TestQuestionMarking(TestCase):
    ...
    def setUp(self):
        self.c1 = Subject.objects.new_subject(subject='elderberries')
...
class TestQuestionViewsUser(TestCase):
    ...
    def test_quiz_take_user_submit(self):
        ...
        self.assertIn(self.c1.subject, progress)
