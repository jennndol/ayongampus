...
from ayongampus.activities.models import Activity
from ayongampus.decorators import ajax_required
from ayongampus.feeds.models import Feed
...
@login_required
def feeds(request):
    # all_feeds = Feed.get_feeds().filter(user__in=request.user.profile.get_following())
